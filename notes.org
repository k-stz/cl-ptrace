...
** Machine Code Disassembly by hand
   ...
   the operand 'e4' trasnlates to: 0xffffffffffffffe4
   The many 0xff...s because 0xe4 has a leading 1 ==> #b11100100 
...
***   Register state throughout (Only RAX, RIP, and EFLAGS changed!):
   ...
   R8      :        55f6b5bf7720   5.
   RAX     :                abcd    
   RCX     :                   0   4.; used for LOOPing in assembly..
   RDX     :        7ffd309ea948   3.
   RSI     :        7ffd309ea938   2.
   RDI     :                   1   1. function/syscall argument
   ORIG_RAX:    ffffffffffffffff    
   RIP     :        55f6b5bf7675   instruction pointer
   CS      :                  33    
   EFLAGS  :                 246   flags used for results of operations and CPU control
   RSP     :        7ffd309ea840   Stack Pointer to last item pushed on stack; grows to lower addresses
   SS      :                  2b    
   FS_BASE :        7faea6b024c0    
   GS_BASE :                   0    
   DS      :                   0    
   ES      :                   0    
   FS      :                   0    
