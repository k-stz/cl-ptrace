...
** Machine Code Disassembly by hand
   ...
   #x55F6B5BF7675 + 5 L=?   2009cf058be474   JZ/JE re18             

   With the help of (gdb) disassembly, we get the assembly instructions:

   0x000000000000065b <+17>:	mov    0x2009f3(%rip),%eax        # 0x201054 <x>
   0x0000000000000661 <+23>:	add    $0x1,%eax
   0x0000000000000664 <+26>:	mov    %eax,0x2009ea(%rip)        # 0x201054 <x>
   0x000000000000066a <+32>:	mov    0x2009dc(%rip),%eax        # 0x20104c <flag>
   0x0000000000000670 <+38>:	cmp    $0xabcd,%eax
