...
*** TODO ALSR - Adress Space Layout Randomzation
    ...
    TODO: when is the offset applied? Once the Process is created or on each process
    switch (probably not)...?
...
** disassembly process hacking
   ...
   TODO: in what memory portion is flagg stored
